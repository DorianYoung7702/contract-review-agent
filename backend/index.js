...
app.use('/api/integrations/dingtalk', require('./routes/integrations/dingtalk'));
app.use('/api/runtime-config', require('./routes/runtimeConfig'));
...
app.get('/', (req, res) => {
  res.send('Contract Review Backend is running!');
});
