...
const { requireRequestUserId, getRequestUserId, findOwnedContract, findAccessibleContract } = require('../../services/contractAnalysis/auth');
...
const { findOrganizationParty } = require('../../services/contractAnalysis/perspective');
...
module.exports = function (router) {
    router.post('/pre-analyze', async (req, res) => {
        ...
        try {
            const contract = await findAccessibleContract(contractId, userId);
...
---`;
            ...
            analysisResult.default_perspective = findOrganizationParty(
