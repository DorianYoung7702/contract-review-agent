...
const getVectorStoreMode = (value = process.env.VECTOR_STORE) => String(value || 'milvus').trim().toLowerCase();
const isKeywordOnlyMode = (value = process.env.VECTOR_STORE) => ['keyword', 'lexical'].includes(getVectorStoreMode(value));
