...
export default {
    ...
    createContractSnapshot(contractId, payload = {}) {
        return apiClient.post(`/contracts/${contractId}/snapshot`, payload);
    },

    getVersionEditorConfig(contractId, versionId) {
        return apiClient.get(`/contracts/${contractId}/versions/${versionId}/editor-config`);
    },
    ...
    exportAnnotatedPdf(contractId) {
        return apiClient.get(`/contracts/${contractId}/export-annotated-pdf`, {
            responseType: 'blob',
        });
    },

    applyRedlines(contractId) {
        return apiClient.post(`/contracts/${contractId}/apply-redlines`);
    },

    exportRedlineVersion(contractId) {
        return apiClient.get(`/contracts/${contractId}/export-redline`, {
            responseType: 'blob',
        });
    },

    confirmCounterpartRedlines(contractId, payload = {}) {
        return apiClient.post(`/contracts/${contractId}/counterpart-confirm`, payload);
    },

    acceptFormalVersion(contractId, payload = {}) {
        return apiClient.post(`/contracts/${contractId}/accept-formal`, payload);
    },

    exportFormalVersion(contractId, format = 'docx') {
        return apiClient.get(`/contracts/${contractId}/export-formal`, {
            params: { format },
            responseType: 'blob',
        });
    },
    ...
    listPlaybooks() {
        return apiClient.get('/contracts/playbooks');
    },

    getContractAudit(contractId) {
        return apiClient.get(`/contracts/${contractId}/audit`);
    },

    overrideDecision(contractId, payload) {
        return apiClient.post(`/contracts/${contractId}/decision/override`, payload);
    },

    recomputeDecision(contractId, payload = {}) {
        return apiClient.post(`/contracts/${contractId}/decision/recompute`, payload);
    },

    confirmDingTalkDecision(payload) {
        return apiClient.post('/integrations/dingtalk/confirm', payload);
    },

    getRuntimeConfig() {
        return apiClient.get('/runtime-config');
    },

    updateRuntimeConfig(payload) {
        return apiClient.put('/runtime-config', payload);
    },

    probeEmbeddingConfig() {
        return apiClient.get('/runtime-config/embedding/probe');
    },

    reembedKnowledge(payload = {}) {
        return apiClient.post('/runtime-config/embedding/reembed', payload);
    },
};
